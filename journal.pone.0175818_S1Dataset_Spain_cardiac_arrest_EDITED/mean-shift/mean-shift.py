...
mean = MeanShift(bandwidth=0.45) #Ho provato diverse configurazioni con bandwidth ottenendo un miglior riscontro con 0.45, mentre per bin_seeding anche se viene impostato a True non cambia il risultato
mean.fit(features)
