...
#Uso la tecnica del gomito per capire quanti cluster formare
inertia = []
...
#Calcolo delle statistiche descrittive di ogni cluster per comprenderne la differenza tra essi
