...
agglomerative = AgglomerativeClustering(n_clusters=4, linkage="ward") #Siccome utilizzo il collegamento "ward" non posso settare l'affinity diversa da euclidean
